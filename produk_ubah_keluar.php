...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="gudang.php" style="color: black;">Home</a> -> <a href="gudang.php" style="color: black;">Gudang</a> -> Ubah Produk
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Ubah Produk</p>
                <form action="" method="post">
                    Nama produk : <input type="text" name="nama_produk" value="<?= $row["nama_produk"]; ?>" required><br><br>
                    Jenis produk : <input type="text" name="jenis_produk" value="<?= $row["jenis_produk"]; ?>" required><br><br>
                    ...
                    Tanggal : <input type="datetime-local" name="tanggal_keluar" value="<?= $row["tanggal_keluar"]; ?>"><br><br>
                ...
                <?php
                    if (isset($_POST["ubahproduk"])) {
                        ...
                        if (mysqli_affected_rows($c) > 0) {
                            echo "<b>Produk berhasil diubah</b>";
                        } else {
