...
<head>
    ...
    <title>Toko Jaya Perkasa - Ubah Pengiriman</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> <a href="pengiriman.php" style="color: black;">Pengiriman</a> -> Ubah Pengiriman
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Ubah Pengiriman</p>
                <form action="" method="post">
                    Nama produk : <input type="text" name="daftar_produk" value="<?= $row["daftar_produk"]; ?>" disabled><br><br>
                    Nama pengirim : <input type="text" name="nama_pengirim" value="<?= $row["nama_pengirim"]; ?>"><br><br>
                    Tanggal retur : <input type="datetime-local" name="waktu_pengiriman" value="<?= $row["waktu_pengiriman"]; ?>"><br><br>        
                    Catatan : <input type="text" name="catatan_pengiriman" value="<?= $row["catatan_pengiriman"]; ?>"><br><br>
                    <button type="submit" name="ubahpengiriman">Ubah</button>       
                </form><br>
                <a href="pengiriman.php"><button>Kembali</button></a><br><br>
                <?php
                    endif;

                    if (isset($_POST["ubahpengiriman"])) {
                        $nama_pengirim = $_POST["nama_pengirim"];
                        $waktu_pengiriman = $_POST["waktu_pengiriman"];
                        $catatan_pengiriman = $_POST["catatan_pengiriman"];

                        $query = "UPDATE pengiriman SET nama_pengirim = '$nama_pengirim',
