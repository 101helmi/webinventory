...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> <a href="retur_pembelian.php" style="color: black;">Retur Pembelian</a> -> Ubah Retur Pembelian
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Ubah Retur Pembelian</p>
                <form action="" method="post">
                    Nama produk : <input type="text" name="nama_produk" value="<?= $row["nama_produk"]; ?>" disabled><br><br>
                    Jumlah : <input type="text" name="jumlah" value="<?= $row["jumlah"]; ?>"><br><br>
                    Tanggal retur : <input type="datetime-local" name="tanggal_retur" value="<?= $row["tanggal_retur"]; ?>"><br><br>        
                    Catatan : <input type="text" name="catatan_retur" value="<?= $row["catatan_retur"]; ?>"><br><br>
                    <button type="submit" name="ubahretur">Ubah</button>       
                </form><br>
                <a href="retur_pembelian.php"><button>Kembali</button></a><br><br>
                <?php
                    endif;

                    if (isset($_POST["ubahretur"])) {
                        $jumlah = $_POST["jumlah"];
                        $tanggal_retur = $_POST["tanggal_retur"];
                        $catatan_retur = $_POST["catatan_retur"];

                        $query = "UPDATE retur_pembelian SET tanggal_retur = '$tanggal_retur',
                                                            jumlah = '$jumlah',
                                                            catatan_retur = '$catatan_retur'
                                                WHERE id_retur_pembelian = $id_retur_pembelian";
