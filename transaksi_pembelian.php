<?php
    ...
    $result_pembelian = mysqli_query($c, $query_pembelian);
...
<head>
    ...
    <title>Toko Jaya Perkasa - Transaksi pembelian</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> Transaksi Pembelian
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Pembelian</p>
                <?php if ($_SESSION["nama"] == "Admin") : ?>
                <a href="transaksi_tambah_pembelian.php"><button>+ Tambah Transaksi Pembelian</button></a>
                <?php endif; ?>
                <table border="1" cellpadding="10" cellspacing="0" style="background-color: white;">
                    ...
                    <tr>
                        <td><?= $i; ?></td>  
                        <td><?= $row_pembelian["no_nota_pembelian"]; ?></td>        
                        <td><?= $row_pembelian["tanggal_pembelian"]; ?></td>
                        <td><?= $row_pembelian["jumlah"]; ?></td>
                        <td><?= "Rp " . number_format($row_pembelian["harga"]); ?></td>
                        <td><?= "Rp " . number_format($row_pembelian["harga"] * $row_pembelian["jumlah"]); ?></td>
                        <td>
                            <a href="transaksi_ubah_pembelian.php?id_pembelian=<?= $row_pembelian["id_pembelian"]; ?>&no_nota_pembelian=<?= $row_pembelian["no_nota_pembelian"]; ?>"><button style="background-color: #C0C0C0;">Ubah</button></a>
                            <a href="transaksi_hapus_pembelian.php?id_pembelian=<?= $row_pembelian["id_pembelian"]; ?>&no_nota_pembelian=<?= $row_pembelian["no_nota_pembelian"]; ?>&jumlah=<?= $row_pembelian["jumlah"]; ?>&nama_produk=<?= $row_pembelian["nama_produk"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus transaksi ini?')"><button style="background-color: #FB7272;">Hapus</button></a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    <?php endwhile; ?>
