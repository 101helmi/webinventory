...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="gudang.php" style="color: black;">Home</a> -> <a href="gudang.php" style="color: black;">Gudang</a> -> Tambah Produk Keluar
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Tambah Produk Keluar</p>
                ...
                <?php
                    ...
                    if (isset($_POST["tambahproduk"])) {
                        ...
                        if (!$data) {
                            ...
                            $id_produk = $data["id_produk"] + 1;
                            $id_riwayatstok = $data["id_riwayatstok"] + 1;
                        }

                        $query1 = "INSERT INTO produk VALUES ('$id_produk', '$nama_produk', '$jenis_produk', '$jumlah_produk', '$harga_produk', '', '$tanggal_keluar', '$satuan', '1')";
                        $query2 = "INSERT INTO riwayatstok VALUES ('$id_riwayatstok', '$tanggal_keluar', '$jumlah_produk', '$id_produk', '1')";
                        ...
                        if (mysqli_affected_rows($c) > 0) {
                            echo "<b>Produk berhasil dikeluarkan dan siap dijual.</b>";
                        } else {
