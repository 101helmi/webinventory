...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> <a href="retur_penjualan.php" style="color: black;">Retur Penjualan</a> -> Ubah Retur Penjualan
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Ubah Retur Penjualan</p>
                ...
                <?php
                    ...
                    if (isset($_POST["ubahretur"])) {
                        ...
                        $query = "UPDATE retur_penjualan SET tanggal_retur = '$tanggal_retur',
                                                            jumlah = '$jumlah',
