<?php
    ...
    $query1 = "SELECT * FROM detil_penjualan WHERE no_nota_penjualan = $no_nota_penjualan";
    $query2 = "SELECT * FROM penjualan WHERE id_penjualan = $id_penjualan";
...
<head>
    ...
    <title>Toko Jaya Perkasa - Ubah Transaksi Penjualan</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> <a href="transaksi_penjualan.php" style="color: black;">Transaksi Penjualan</a> -> Ubah Transaksi Penjualan
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Ubah Transaksi Penjualan</p>
                <form action="" method="post">
                    No. Nota : <input type="text" name="no_nota_penjualan" value="<?= $row["no_nota_penjualan"]; ?>" disabled><br><br>
                    ...
                    Tanggal penjualan : <input type="datetime-local" name="tanggal_penjualan" value="<?= $row2["tanggal_penjualan"]; ?>"><br><br>  
                ...
                <?php
                    ...
                    if (isset($_POST["ubahtransaksi"])) {
                        ...
                        $query = "UPDATE detil_penjualan
                                INNER JOIN penjualan
                                ON detil_penjualan.penjualan_id = penjualan.id_penjualan
                                SET jumlah = '$jumlah',
