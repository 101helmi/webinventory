...
<head>
    ...
    <title>Toko Jaya Perkasa - Registrasi (Kepala Gudang)</title>
</head>
<body>
    <h1>Registrasi Kepala Gudang</h1>
...
<?php
    if (isset($_POST["submit"])) {
        ...
        $query = "INSERT INTO kepala_gudang VALUES ('', '$nama', '$email', '$username', '$password_hash', '$no_hp')";
