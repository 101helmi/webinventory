...
<head>
    ...
    <title>Toko Jaya Perkasa - Ubah Transaksi Pengeluaran</title>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                ...
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Ubah Transaksi Pengeluaran</p>
                <form action="" method="post">
                    Tanggal Pengeluaran : <input type="datetime-local" name="tanggal_pengeluaran" value="<?= $row["tanggal_pengeluaran"]; ?>" required><br><br>
                    Detail Pengeluaran : <input type="text" name="detail_pengeluaran" value="<?= $row["detail_pengeluaran"]; ?>" required><br><br>
                    Jumlah : <input type="text" name="jumlah" value="<?= $row["jumlah"]; ?>" required><br><br>
                    Harga satuan : <input type="text" name="harga" value="<?= $row["harga"]; ?>" required><br><br>
                ...
                <?php
                    if (isset($_POST["ubahtransaksi"])) {
                        ...
                        $query = "UPDATE pengeluaran SET tanggal_pengeluaran = '$tanggal_pengeluaran',
                        ...
                        if (mysqli_affected_rows($c) > 0) {
                            echo "<b>Transaksi pengeluaran berhasil diubah</b>";
                        } else {
