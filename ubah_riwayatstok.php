<?php
    ...
    $query = "SELECT * 
              ...
              WHERE id_riwayatstok = $id_riwayatstok";
...
<h1>Maaf hanya manager dan kepala gudang yang bisa mengubah data riwayat stok</h1>
...
<head>
    ...
    <title>Toko Jaya Perkasa - Ubah Riwayat Stok</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="gudang.php" style="color: black;">Home</a> -> <a href="gudang.php" style="color: black;">Gudang</a> -> <a href="riwayatstok.php" style="color: black;">Riwayat Stok</a> -> Ubah Riwayat Stok
                <br><br>
                ...
                <form action="" method="post">
                    ...
                    Jumlah : <input type="text" name="jumlah_barang_keluarmasuk" value="<?= $row["jumlah_barang_keluarmasuk"]; ?>"><br><br>
                    Tanggal : <input type="datetime-local" name="tanggal" value="<?= $row["tanggal"]; ?>"><br><br>
                    <button type="submit" name="ubahriwayatstok">Ubah</button>       
                </form><br>
                <a href="riwayatstok.php"><button>Kembali</button></a><br><br>
                <?php
                    endif;

                    if (isset($_POST["ubahriwayatstok"])) {
                        $jumlah_barang_keluarmasuk = $_POST["jumlah_barang_keluarmasuk"];
                        $tanggal = $_POST["tanggal"];

                        $query = "UPDATE riwayatstok SET tanggal = '$tanggal',
                                                        jumlah_barang_keluarmasuk = '$jumlah_barang_keluarmasuk'
                                                    WHERE id_riwayatstok = $id_riwayatstok";
