...
<head>
    ...
    <title>Toko Jaya Perkasa - Ubah Supplier</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="gudang.php" style="color: black;">Home</a> -> <a href="gudang.php" style="color: black;">Gudang</a> -> <a href="supplier.php" style="color: black;">Supplier</a> -> Ubah Supplier
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Ubah Supplier</p>
                <form action="" method="post">
                    Nama supplier : <input type="text" name="nama_supplier" value="<?= $row["nama_supplier"]; ?>" required><br><br>
                    Alamat : <input type="text" name="alamat" value="<?= $row["alamat"]; ?>" required><br><br>
                    Handphone : <input type="text" name="handphone" value="<?= $row["handphone"]; ?>" required><br><br>
                    <button type="submit" name="ubahsupplier">Ubah</button>       
                </form><br>
                <a href="supplier.php"><button>Kembali</button></a><br><br>
                <?php
                    if (isset($_POST["ubahsupplier"])) {
                        ...
                        if (mysqli_affected_rows($c) > 0) {
                            echo "<b>Data supplier berhasil diubah</b>";
                        } else {
