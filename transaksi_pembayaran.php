...
<head>
    ...
    <title>Toko Jaya Perkasa - Transaksi Pembayaran</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> Transaksi Pembayaran
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Pembayaran</p>
                <?php if ($_SESSION["nama"] == "Admin") : ?>
                <a href="transaksi_tambah_pembayaran.php"><button>+ Tambah Transaksi Pembayaran</button></a>
                <?php endif; ?>
                <table border="1" cellpadding="10" cellspacing="0" style="background-color: white;">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="transaksi_ubah_pembayaran.php?id_pembayaran=<?= $row["id_pembayaran"]; ?>&no_nota_pembayaran=<?= $row["no_nota_pembayaran"]; ?>"><button style="background-color: #C0C0C0;">Ubah</button></a>
                            <a href="transaksi_hapus_pembayaran.php?id_pembayaran=<?= $row["id_pembayaran"]; ?>&no_nota_pembayaran=<?= $row["no_nota_pembayaran"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus transaksi ini?')"><button style="background-color: #FB7272;">Hapus</button></a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    <?php endwhile; ?>
