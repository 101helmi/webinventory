...
<head>
    ...
    <title>Toko Jaya Perkasa - Supplier</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="gudang.php" style="color: black;">Home</a> -> <a href="gudang.php" style="color: black;">Gudang</a> -> Supplier
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Supplier</p>
                <?php if ($_SESSION["nama"] == "Kepala Gudang") : ?>
                <a href="supplier_tambah.php"><button>+ Tambah Supplier</button></a>
                <?php endif; ?>
                <table border="1" cellpadding="10" cellspacing="0" style="background-color: white;">
                    ...
                    <tr>
                        ...
                        <td><?= $row["handphone"]; ?></td>
                        <td>
                            <a href="supplier_ubah.php?id_supplier=<?= $row["id_supplier"]; ?>"><button style="background-color: #C0C0C0;">Ubah</button></a>
                            <a href="supplier_hapus.php?id_supplier=<?= $row["id_supplier"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus supplier ini?')"><button style="background-color: #FB7272;">Hapus</button></a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    <?php endwhile; ?>
