        ...
        <div class="row flex-nowrap">
            ...
            <a href="index.php" style="color: black;">Home</a> -> Laporan Transaksi
                ...
                <form action="" method="post">
                    Pilih transaksi : 
                    <select name="pilih_transaksi" id="pilih_transaksi">
                ...
                <?php
                    $jenis_tranksaksi = "";
                    if (isset($_POST["pilih_jenistransaksi"])) {
                        ...
                        if ($pilih_transaksi == "Penjualan") {
                            ...
                            $url_cetak = "cetak_laporan_transaksi.php?jenis_transaksi=".$pilih_transaksi; 
                        }
                    ...
                    if (isset($_POST["pilih_periode"])) {
                        ...
                        if ($pilih_transaksi == "Penjualan") {
                            ...
                            $jenis_tranksaksi = "penjualan";
                            echo "<b> " . $jenis_tranksaksi . "</b>";

                            $url_cetak = "cetak_laporan_transaksi.php?jenis_transaksi=".$pilih_transaksi."&tanggal_awal=".$tanggal_awal."&tanggal_akhir=".$tanggal_akhir; 
                        }
                        if ($pilih_transaksi == "Pembelian") {
                            $query = "SELECT tanggal_pembelian as tanggal, jumlah, harga 
                                    FROM detil_pembelian d
                        ...
                        echo "<br>";
                        echo "<b>" . $_POST["tanggal_awal"] . " - " . $_POST["tanggal_akhir"] . "</b>";
                    }
