...
<head>
    ...
    <title>Toko Jaya Perkasa - Transaksi Pengeluaran</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> Transaksi Pengeluaran
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Pengeluaran</p>
                <?php if ($_SESSION["nama"] == "Admin") : ?>
                <a href="transaksi_tambah_pengeluaran.php"><button>+ Tambah Transaksi Pengeluaran</button></a>
                <?php endif; ?>
                <table border="1" cellpadding="10" cellspacing="0" style="background-color: white;">
                    ...
                    <tr>
                        ...
                        <td><?= $row["detail_pengeluaran"]; ?></td>
                        <td><?= $row["jumlah"]; ?></td>
                        <td><?= "Rp " . number_format($row["harga"], 2, ",", "."); ?></td>
                        <td><?= "Rp " . number_format($row["harga"] * $row["jumlah"], 2, ",", "."); ?></td>
                        <td>
                            <a href="transaksi_ubah_pengeluaran.php?id_pengeluaran=<?= $row["id_pengeluaran"]; ?>"><button style="background-color: #C0C0C0;">Ubah</button></a>
                            <a href="transaksi_hapus_pengeluaran.php?id_pengeluaran=<?= $row["id_pengeluaran"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus produk ini?')"><button style="background-color: #FB7272;">Hapus</button></a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    <?php endwhile; ?>
