...
<head>
    ...
    <title>Toko Jaya Perkasa - Retur Pembelian</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> Retur Pembelian
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Retur Pembelian</p>
                <?php if ($_SESSION["nama"] == "Admin") : ?>
                <a href="tambah_retur_pembelian.php"><button>+ Tambah Retur Pembelian</button></a>
                <?php endif; ?>
                <table border="1" cellpadding="10" cellspacing="0" style="background-color: white;">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="ubah_retur_pembelian.php?id_retur_pembelian=<?= $row["id_retur_pembelian"]; ?>"><button style="background-color: #C0C0C0;">Ubah</button></a>
                            <a href="hapus_retur_pembelian.php?id_retur_pembelian=<?= $row["id_retur_pembelian"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus retur ini?')"><button style="background-color: #FB7272;">Hapus</button></a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    <?php endwhile; ?>
