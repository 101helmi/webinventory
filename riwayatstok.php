...
<head>
    ...
    <title>Toko Jaya Perkasa - Riwayat Stok</title>
...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
            <a href="gudang.php" style="color: black;">Home</a> -> <a href="gudang.php" style="color: black;">Gudang</a> -> Riwayat Stok
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Riwayat Stok</p>
                <table border="1" cellpadding="10" cellspacing="0" style="background-color: white;">
                    ...
                    <tr>
                        ...
                        <td><?= $row["jumlah_barang_keluarmasuk"]; ?></td>
                        <td>
                            <a href="ubah_riwayatstok.php?id_riwayatstok=<?= $row["id_riwayatstok"]; ?>"><button style="background-color: #C0C0C0;">Ubah</button></a>
                            <a href="hapus_riwayatstok.php?id_riwayatstok=<?= $row["id_riwayatstok"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus riwayat ini?')"><button style="background-color: #FB7272;">Hapus</button></a>
                        </td>
                    </tr>
                <?php $i++ ?>
                <?php endwhile; ?>
