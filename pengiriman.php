...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="row flex-nowrap">
            ...
            <div class="col py-5">
                <a href="index.php" style="color: black;">Home</a> -> Pengiriman
                <br><br>
                <p style="font-size: 35px; font-family: Arial, Helvetica, sans-serif;">Pengiriman</p>
                <table border="1" cellpadding="10" cellspacing="0" style="background-color: white;">
                    ...
                    <tr>
                        <td><?= $i; ?></td>  
                        <td><?= $row["daftar_produk"]; ?></td>        
                        <td><?= $row["nama_pengirim"]; ?></td>
                        <td><?= $row["waktu_pengiriman"]; ?></td>
                        <td><?= $row["catatan_pengiriman"]; ?></td>
                        <td>
                            <a href="ubah_pengiriman.php?id_pengiriman=<?= $row["id_pengiriman"]; ?>"><button style="background-color: #C0C0C0;">Ubah</button></a>
                            <a href="hapus_pengiriman.php?id_pengiriman=<?= $row["id_pengiriman"]; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus transaksi ini?')"><button style="background-color: #FB7272;">Hapus</button></a>
                        </td>
                    </tr>
                    <?php $i++ ?>
                    <?php endwhile; ?>
    ...
    <h1>Ini adalah halaman transaksi pembayaran</h1><br><br>
    <a href="transaksi.php"><button>Kembali</button></a><br><br>
